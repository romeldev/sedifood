                            ...
                            <v-row>
                                ...
                                <v-col cols="12" sm="12">
                                    <v-select dense outlined
                                        ...
                                        :items="orderedPrinters"
                                        label="Impresora*"
                                        item-value="id"
                                        item-text="descrip"
                                        hide-details="auto"
                                        :error="form.errors.has('printer_id')"
                                        :error-messages="form.errors.get('printer_id')"
                                    ></v-select>
                                </v-col>
                            </v-row>
                        </v-col>
...
export default {
    data () {
        return {
            ...
            headers: [
                ...
                { text: 'Impresora', value: 'printer.descrip' },
    ...
    methods: {
        ...
        async getMeta() {
            try {
                const params = { service: `get-meta-crud-kitchens` }
