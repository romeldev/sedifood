                            ...
                            <v-row>
                                ...
                                <v-col cols="12" sm="12">
                                    <v-text-field outlined dense
                                        ...
                                        :error-messages="form.errors.get('pin')"
                                    ></v-text-field>
                                </v-col>
                            </v-row>
                        </v-col>
...
export default {
    ...
    computed: {
        ...
        orderedRoles() {
            return this.meta.roles.sort((a, b) => a.name.localeCompare(b.name) );
        },
    },
    ...
    methods: {
        ...
        async getMeta() {
            try {
                const params = { service: `get-meta-crud-users` }
